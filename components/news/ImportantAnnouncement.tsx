  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <article className="group grid overflow-hidden border border-stone-200 bg-stone-50 text-stone-900 transition-shadow has-[:focus-visible]:ring-2 has-[:focus-visible]:ring-brand-green-400 has-[:focus-visible]:ring-offset-2 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <Link
          ...
          >
            ...
            <div className="relative flex flex-col justify-center px-6 py-10 sm:px-10 lg:px-14 lg:py-14">
              ...
              <div className="relative">
                ...
                <span className="mt-8 inline-flex w-fit items-center gap-3 border-b border-brand-green-600 pb-1.5 text-sm font-bold text-stone-900 transition-colors group-hover:border-brand-green-800 group-hover:text-brand-green-800">
                  {copy.news.readMore}
                  <ArrowRight
