...
export default function AboutPreview() {
  ...
  return (
    ...
    >
      <Link
        href="/about"
        className="group block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-green-500 focus-visible:ring-offset-4"
      >
        <div className="mx-auto grid max-w-7xl items-stretch px-4 sm:px-6 lg:grid-cols-12 lg:px-8">
          ...
          >
            ...
            <div className="mt-9 border-t border-stone-200 pt-7">
              <span className="inline-flex items-center gap-3 font-sans text-sm font-bold text-brand-green-800 transition-colors group-hover:text-brand-green-600">
